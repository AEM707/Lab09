...
def main():
    key_books = ('Book/gatsby.txt', 'Book/huckleberry finn.txt', 'Book/romeo.txt')
...
#process_books('./Book/gatsby.txt')
#process_books('./Book/romeo.txt')
#cb = generate_code_book()
#message = input("Type your secret message:")
#print(
    #encrypt(
        #load('./Code_books/book1.json', './Book/gatsby.txt', './Book/romeo.txt', reverse=True), message))
